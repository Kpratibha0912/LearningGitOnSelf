...
# Sum Validation for the total amount
prices = driver.find_element(By.XPATH, "//tr/td[5]/p")
...
discountedAmount = int(driver.find_element(By.XPATH, "//span[@class = 'discountAmt']").text)
